...
"""@asynctest.fail_on(unused_loop=True, active_selector_callbacks=True, active_handles=True)
class TestPatchNotes(asynctest.TestCase):
...
"""@asynctest.fail_on(unused_loop=True, active_selector_callbacks=True, active_handles=True)
class TestUserMethods(asynctest.TestCase):
    use_default_loop = False
